                    ...
                    <div class="col-lg-4 col-xl-4 col-xxl-4">
                        <div class="frame-area">
                            ...
                            <div class="frame-text frame-bottom-space mb-60">
                                ...
                                <p class="frame-content">It is a long established fact that a reader will be distracted
                        ...
                        <div class="main-left">
                            ...
                            <div class="book-area mt-5">
                                <div class="book-wrapper d-flex justify-content-center">
                                    <a href="./liabrary.php?book=1"><img src="./assets/images/astrology-book.png" data-id="personal-diary_front.jpg" class="" alt=""></a>
                                    <a href="./liabrary.php"><img src="./assets/images/Special-Events-book.png" data-id="special-events-back.jpg" class="" alt=""></a>
                                    <a href="./liabrary.php"><img src="./assets/images/In-Memory-book.png" data-id="front-cover.png" class="" alt=""></a>
                                    <a href="./liabrary.php"><img src="./assets/images/Couple-Diary-book.png" data-id="coupleDiary.jpg" class="" alt=""></a>
                                </div>
                                <img src="./assets/images/shelf-books.png" class="w-100 main-shelf" alt="">
                            </div>
                            <div class="book-area mt-4">
                                <div class="book-wrapper d-flex justify-content-center">
                                    <a href="./poets.php?book=15"><img src="./assets/images/Poems-Collection.png" data-id="poems_front.jpg" class="" alt=""></a>
                                    <a href="./poets.php?book=16"><img src="./assets/images/poem-one-love.png" data-id="40-poems_front.jpg" class="" alt=""></a>
                                    <a href="./poets.php?book=17"><img src="./assets/images/Quotes-Collection.png" data-id="quotes_front.jpg" class="" alt=""></a>
                                    <a href="./poets.php?book=18"><img src="./assets/images/Daily-Quotes-Weekly-Poems.png" data-id="daily-quotes_front.jpg" class="" alt=""></a>
                                </div>
                                <img src="./assets/images/shelf-books.png" class="w-100 main-shelf" alt="">
                            </div>
                            <div class="book-area mt-4">
                                <div class="book-wrapper d-flex justify-content-center">
                                    <a href="javascript:;"><img src="./assets/images/My-life-in-pictures.png" class="img-fluid" alt=""></a>
                                    <a href="javascript:;"><img src="./assets/images/The-Story-Of-My-Life.png" class="img-fluid" alt=""></a>
                                </div>
                                <img src="./assets/images/shelf-books.png" class="w-100 main-shelf" alt="">
                            </div>
                        </div>
