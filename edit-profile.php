<script>
    document.title = "Edit Profile | Memorable World";
                ...
                <div class="row">
                    <div id="canvas">
                        <div id="book-zoom" style="visibility: hidden;height: 600px;transform: scale(0.2);">
                            ...
                            <button class="filter-button"><img src="./assets/images/add-page.png" alt=""></button>
                        ...
                        <div class="main-left">
                            ...
                            <div class="book-area mt-5">
                                <div class="book-wrapper d-flex justify-content-center">
                                    <a href="#"><img id="book-1" src="./assets/images/astrology-book.png" data-id="personal-diary_front.jpg" data-page="assets/pages/manage-profile/edit-profile" class=" initBook" alt=""></a>
                                </div>
