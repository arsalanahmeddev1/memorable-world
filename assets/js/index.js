...
let headBtn = document.querySelectorAll(".header-btns")
headBtn.forEach(el => {
    el.addEventListener("click", (e) => {
        let crossButton = document.querySelectorAll('.cross-button')
        hideAndVisibleFunc('.book-search-button', 'visiblity', 'hidden');
        hideAndVisibleFunc('.bookSearchButton', 'visibility', 'hidden');
        hideAndVisibleFunc('.library-search-button', 'display', 'none');
        hideAndVisibleFunc('.editor-btn', 'display', 'none');
        hideAndVisibleFunc('.upload-button', 'display', 'none');
        hideAndVisibleFunc('.filter-button', 'display', 'none');
        crossButton.forEach(el => {
            el.classList.add('header-active')
            el.addEventListener('click', () => {
                hideAndVisibleFunc('.library-search-button', 'display', 'block');
                hideAndVisibleFunc('.upload-button', 'display', 'block');
                hideAndVisibleFunc('.editor-btn', 'display', 'block');
                hideAndVisibleFunc('.filter-button', 'display', 'block');
                setTimeout(() => {
